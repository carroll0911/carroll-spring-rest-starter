...
import static com.carroll.spring.rest.starter.swagger.properties.ApiModelPropertiesWrapper.findApiModePropertyAnnotation;
import static com.carroll.spring.rest.starter.swagger.properties.ApiModelPropertiesWrapper.toAllowableValues;
import static com.carroll.spring.rest.starter.swagger.schema.ApiModelPropertiesWrapper.*;
...
public class ApiModelPropertyPropertyBuilderWrapper implements ModelPropertyBuilderPlugin {
    @Override
    public void apply(ModelPropertyContext context) {
        Optional<ApiModelPropertyWrapper> annotation = Optional.absent();
